...
namespace DiscordRepair.Migrations
{
    ...
    [Migration("20220808005238_UserSchemaUpdate1")]
    partial class UserSchemaUpdate1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Backup", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Channel.CategoryChannel", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Channel.TextChannel", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Channel.VoiceChannel", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Emoji", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.GuildUser", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Message", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Permissions.ChannelPermissions", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Permissions.RolePermissions", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Role", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Sticker", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.Blacklist", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.CustomBot", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.LogModels.Errors", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.LogModels.Statistics", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.Member", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.Server", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.ServerSettings", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.Statistics.GuildMigration", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.Statistics.MemberMigration", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.User", b =>
                {
                    b.Property<Guid>("key")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Backup", b =>
                {
                    b.HasOne("DiscordRepair.Database.Models.User", null)
                        .WithMany("backups")
                        .HasForeignKey("Userkey");

                    b.HasOne("DiscordRepair.Database.Models.BackupModels.Channel.VoiceChannel", "afkChannel")
                        .WithMany()
                        .HasForeignKey("afkChannelkey");

                    b.HasOne("DiscordRepair.Database.Models.BackupModels.Channel.TextChannel", "defaultChannel")
                        .WithMany()
                        .HasForeignKey("defaultChannelkey");

                    b.HasOne("DiscordRepair.Database.Models.BackupModels.Channel.TextChannel", "publicUpdatesChannel")
                        .WithMany()
                        .HasForeignKey("publicUpdatesChannelkey");

                    b.HasOne("DiscordRepair.Database.Models.BackupModels.Channel.TextChannel", "rulesChannel")
                        .WithMany()
                        .HasForeignKey("rulesChannelkey");

                    b.HasOne("DiscordRepair.Database.Models.BackupModels.Channel.TextChannel", "systemChannel")
                        .WithMany()
                        .HasForeignKey("systemChannelkey");

                    b.HasOne("DiscordRepair.Database.Models.BackupModels.Channel.TextChannel", "widgetChannel")
                        .WithMany()
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Channel.CategoryChannel", b =>
                {
                    b.HasOne("DiscordRepair.Database.Models.BackupModels.Backup", null)
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Channel.TextChannel", b =>
                {
                    ...
                    b.HasOne("DiscordRepair.Database.Models.BackupModels.Channel.CategoryChannel", "category")
                        .WithMany()
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Message", b =>
                {
                    b.HasOne("DiscordRepair.Database.Models.BackupModels.Channel.TextChannel", null)
                        .WithMany("messages")
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Permissions.ChannelPermissions", b =>
                {
                    b.HasOne("DiscordRepair.Database.Models.BackupModels.Channel.CategoryChannel", null)
                    ...
                    b.HasOne("DiscordRepair.Database.Models.BackupModels.Channel.VoiceChannel", null)
                        .WithMany("permissions")
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.BackupModels.Role", b =>
                {
                    ...
                    b.HasOne("DiscordRepair.Database.Models.BackupModels.GuildUser", null)
                        .WithMany("assignedRoles")
                        .HasForeignKey("GuildUserkey");

                    b.HasOne("DiscordRepair.Database.Models.BackupModels.Permissions.RolePermissions", "permissions")
                        .WithMany()
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.Blacklist", b =>
                {
                    b.HasOne("DiscordRepair.Database.Models.ServerSettings", null)
                        .WithMany("blacklist")
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.LogModels.Statistics", b =>
                {
                    b.HasOne("DiscordRepair.Database.Models.User", "MigratedBy")
                        .WithMany()
                        .HasForeignKey("MigratedBykey");

                    b.HasOne("DiscordRepair.Database.Models.Statistics.GuildMigration", "guildStats")
                        .WithMany()
                        .HasForeignKey("guildStatskey");

                    b.HasOne("DiscordRepair.Database.Models.Statistics.MemberMigration", "memberStats")
                        .WithMany()
                        .HasForeignKey("memberStatskey");

                    b.HasOne("DiscordRepair.Database.Models.Server", "server")
                        .WithMany()
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.Member", b =>
                {
                    b.HasOne("DiscordRepair.Database.Models.CustomBot", "botUsed")
                        .WithMany()
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.Server", b =>
                {
                    b.HasOne("DiscordRepair.Database.Models.User", "owner")
                        .WithMany()
                        .HasForeignKey("ownerkey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DiscordRepair.Database.Models.ServerSettings", "settings")
                        .WithMany()
            ...
            modelBuilder.Entity("DiscordRepair.Database.Models.ServerSettings", b =>
                {
                    b.HasOne("DiscordRepair.Database.Models.CustomBot", "mainBot")
                        .WithMany()
